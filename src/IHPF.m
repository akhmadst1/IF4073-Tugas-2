function resultImage = IHPF(inputImage, D0)
    % Fungsi untuk melakukan high-pass filtering menggunakan Ideal High-Pass Filter (IHPF)
    ...
    % Step 3: Membuat filter ideal high-pass
    % Filter IHPF dibuat dengan menggunakan ILPF dan mengurangkan dari 1
    H = 1 - ILPFFilter(P, Q, D0);
